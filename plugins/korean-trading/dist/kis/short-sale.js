...
async function main() {
  ...
  try {
    const json = await kisGet("/uapi/domestic-stock/v1/quotations/inquire-daily-itemchartprice", "FHKST03010100", {
    ...
    const rows = (json.output ?? []).filter((r) => r.stck_bsop_date).map((r) => ({
