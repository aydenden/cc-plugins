...
async function main() {
  ...
  try {
    const json = await kisGet("/uapi/domestic-stock/v1/quotations/inquire-time-itemchartprice", "FHKST03010200", {
      FID_ETC_CLS_CODE: "",
    ...
    const candles = (json.output2 ?? []).filter((r) => r.stck_cntg_hour).map((r) => ({
